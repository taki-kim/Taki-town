  ...
  return (
    <div className={styles["wrapper"]}>
      ...
      <div className={styles["text-wrapper"]}>
        <br />
        <p>
          안녕하세요 저는 웹 프론트엔드 개발자 Taki입니다. 이곳은 저의 개인
          블로그입니다. 개발자로서의 배움과 목표를 향한 여정을 기록하기 위해
          운영하고 있습니다. 하지만 단지 개발만 말하지는 않습니다. 이곳에 저의
          개인적인 의미들을 채우고, 가치 있는 공간으로 만들어가려 합니다.
        </p>
        <br />
        <p>
          저는 여러가지 것들을 좋아합니다. 만화와 애니메이션을 좋아하는
          오타쿠고, 무서운 이야기나 영화들을 찾아보기도 합니다. 인문학을
          좋아해서 이따금 인문학 책들도 읽고 가끔씩은 떠오르는 잡념들도
          끄적여보고는 합니다. 저는 이곳에서 이런 관심사와 경험들을 가능한 많이
          기록해보려 합니다. 둘러보시면서 '이 사람은 이렇게 사는구나, 이런
          이야기도 있구나' 하고 흥미로운 시간이 되시길 바라고 있습니다.
        </p>
      </div>
